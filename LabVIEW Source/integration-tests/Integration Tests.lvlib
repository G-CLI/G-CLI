...
<Library LVVersion="18008000">
	...
	<Item Name="Check Unicode Response HÜll°.vi" Type="VI" URL="../Check Unicode Response HÜll°.vi"/>
	<Item Name="Check Unicode Response.vi" Type="VI" URL="../Check Unicode Response.vi"/>
